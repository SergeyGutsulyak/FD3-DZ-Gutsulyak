  ...
  render() {
    ...
    return (
      <div>
        ...
        <NavLink to="/search_users" className="PageLink" activeClassName="ActivePageLink" >Поиск пользователей</NavLink>
        <NavLink to="/groups_select" className="PageLink" activeClassName="ActivePageLink" >Отбор групп</NavLink>
      </div>
    );
