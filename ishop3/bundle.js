...
var _Ishop = __webpack_require__(26);
...
var itemsArr = [{ title: 'Универсальный набор инструментов Yato 216 предметов', description: 'универсальный набор, 1/4", 3/8", 1/2", 216 предметов', price: 250, imgURL: 'images/frs1.jpg', count: 15, code: 1 }, { title: 'Force 41082 108 предметов (для сорванных граней)', description: 'универсальный набор, 1/4", 1/2", 108 предметов', price: 196, imgURL: 'images/frs2.jpg', count: 21, code: 2 }, { title: 'FORSAGE 108 предметов 6 граней (41082-5)', description: 'универсальный набор, 1/4", 1/2", 108 предметов', price: 123, imgURL: 'images/frs3.jpg', count: 13, code: 3 }, { title: 'Force 4821 82 предмета', description: 'универсальный набор, 1/4", 1/2", 82 предмета', price: 170.29, imgURL: 'images/frs4.jpg', count: 9, code: 4 }, { title: 'PRO Startul PRO-111N 111 предметов', description: 'набор торцевых головок, 1/4", 1/2", 111 предмет', price: 168.60, imgURL: 'images/frs5.jpg', count: 15, code: 5 }, { title: 'Force 41421 142 предмета', description: 'универсальный набор, 1/4", 3/8", 1/2", 142 предмета', price: 457, imgURL: 'images/frs6.jpg', count: 16, code: 6 }];
...
*/
var aa=__webpack_require__(4),ba=__webpack_require__(1),m=__webpack_require__(10),p=__webpack_require__(2),v=__webpack_require__(3),da=__webpack_require__(11),ea=__webpack_require__(12),fa=__webpack_require__(13),ha=__webpack_require__(5);
...
var _ItemForm = __webpack_require__(32);
...
var Ihop2 = function (_React$Component) {
  _inherits(Ihop2, _React$Component);
  ...
  function Ihop2() {
    ...
    _classCallCheck(this, Ihop2);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Ihop2.__proto__ || Object.getPrototypeOf(Ihop2)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      curItemsArr: _this.props.itemsArr,
      selectCode: 0,
      curItem: null

      //поиск позиции в массиве товаров по cod
    }, _this.findItem = function (cod) {
      //console.log('Вызывается поиск');
      for (i in _this.state.curItemsArr) {
        if (_this.state.curItemsArr[i].code == cod) return { el: _this.state.curItemsArr[i], index: i };
      }
      console.log('Не найден');
      return null;
    }, _this.deleteItem = function (cod) {
      var fObj = _this.findItem(cod);
      _this.state.curItemsArr.splice(fObj.index, 1);
      _this.setState({ curItemsArr: _this.state.curItemsArr, curItem: null });
      //console.log(cod);
    }, _this.selectItem = function (cod) {
      var fObj = _this.findItem(cod);
      //сначала закрываем, потом снова создаем, чтобы обнавились defaultValue
      _this.setState({ curItem: null }, function () {
        return _this.setState({ selectCode: cod, curItem: fObj.el, lockEdit: true });
      });
    }, _this.selectChItem = function (cod) {

      var fObj = _this.findItem(cod);
      //сначала закрываем, потом снова создаем, чтобы обнавились defaultValue
      _this.setState({ curItem: null }, function () {
        return _this.setState({ selectCode: cod, curItem: fObj.el, lockEdit: false });
      });
      console.log('Изменение разрешено');
    }, _this.addedItem = function (EO) {
      //поиск максимального значение кода, новый код максимум старый +1
      var newCode = Math.max(_this.state.curItemsArr.reduce(function (e, v) {
        return Math.max(v.code, e);
      }, 0)) + 1;
      ...
      _this.setState({ curItem: null }, function () {
        return _this.setState({ selectCode: newCode, curItem: newI });
      });
    }, _this.changeItem = function (newI) {
      //console.log(item);
      //console.log(this.state.curItemsArr);
      var fObj = _this.findItem(newI.item.code);
      console.log(fObj);
      if (fObj) {
        _this.state.curItemsArr[fObj.index] = newI.item;
        _this.setState({ curItemsArr: _this.state.curItemsArr });
      } else {
        _this.state.curItemsArr.push(newI.item);
        _this.setState({ curItemsArr: _this.state.curItemsArr });
      }
    }, _this.closeForm = function () {
      _this.setState({ curItem: null });
  ...
  _createClass(Ihop2, [{
    ...
    value: function render() {
      ...
      if (this.state.curItem) {
        ...
        curItemForm = _react2.default.createElement(_ItemForm2.default, {
      ...
      var itemsCode = [];
      this.state.curItemsArr.forEach(function (itemEl) {
        var selIt = false;
        if (itemEl.code == _this2.state.selectCode) {
          selIt = true;
        }
        var itemCode = _react2.default.createElement(_Item2.default, {
          key: itemEl.code,
          selected: selIt,
          item: itemEl,
          cbDeleteItem: _this2.deleteItem,
          cbSelectItem: _this2.selectItem,
          cbSelectChItem: _this2.selectChItem
        });
...
var Item = function (_React$Component) {
    ...
    function Item() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Item.__proto__ || Object.getPrototypeOf(Item)).call.apply(_ref, [this].concat(args))), _this), _this.selectChItem = function (EO) {
            _this.props.cbSelectChItem(_this.props.item.code);
            EO.stopPropagation();
        }, _this.deleteItem = function (EO) {
            if (confirm('Удалть элемент?')) {
                _this.props.cbDeleteItem(_this.props.item.code);
                EO.stopPropagation();
            }
        }, _this.selectIem = function () {
            _this.props.cbSelectItem(_this.props.item.code);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'Item' + strClass,
                    onClick: this.selectIem },
                _react2.default.createElement('img', { src: this.props.item.imgURL, className: 'ItemImage' }),
                _react2.default.createElement(
                    'div',
                    { className: 'ItemGroup' },
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'p',
                            { className: 'dDescriptonText' },
                            this.props.item.description
                        ),
                        _react2.default.createElement(
                            'p',
                            { className: 'count' },
                            'В наличии: ' + this.props.item.count
                        ),
                        _react2.default.createElement('input', { type: 'button', value: '\u0418\u0437\u043C\u0435\u043D\u0438\u0442\u044C', onClick: this.selectChItem }),
                        _react2.default.createElement('input', { type: 'button', value: '\u0423\u0434\u0430\u043B\u0438\u0442\u044C', onClick: this.deleteItem })
                    )
                ),
                _react2.default.createElement(
                    'div',
...
Item.propTypes = {
    ...
    cbSelectChItem: _propTypes2.default.func.isRequired,
...
var ItemForm = function (_React$Component) {
    ...
    function ItemForm() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ItemForm.__proto__ || Object.getPrototypeOf(ItemForm)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            curItem: _this.props.item,
            chImgURL: { errText: '', err: 0, data: _this.props.item.imgURL },
            chCount: { errText: '', err: 0, data: _this.props.item.count },
            chTitle: { errText: '', err: 0, data: _this.props.item.title },
            chDescription: { errText: '', err: 0, data: _this.props.item.description },
            chPrice: { errText: '', err: 0, data: _this.props.item.price },
            chCode: _this.props.item.code
        }, _this.changeTitle = function (EO) {
            if (EO.target.value == '') {
                _this.setState({ chTitle: { errText: 'Поле не может быть пустым', err: 1 } });
            } else _this.setState({ chTitle: { errText: '', err: 0, data: EO.target.value } });
        }, _this.changeDescription = function (EO) {
            if (EO.target.value == '') {
                _this.setState({ chDescription: { errText: 'Поле не может быть пустым', err: 1 } });
            } else _this.setState({ chDescription: { errText: '', err: 0, data: EO.target.value } });
        }, _this.changePrice = function (EO) {
            if (EO.target.value == '') {
                _this.setState({ chPrice: { errText: 'Поле не может быть пустым', err: 1 } });
            } else {
                var val = Number.parseFloat(EO.target.value);
                if (!val) {
                    _this.setState({ chPrice: { errText: 'Значение должно быть числом', err: 1 } });
                } else if (val < 0) {
                    _this.setState({ chPrice: { errText: 'Значение должно быть больше нуля', err: 1 } });
                } else _this.setState({ chPrice: { errText: '', err: 0, data: val } });
            }
        }, _this.changeCount = function (EO) {
            //console.log(EO.target.value)
            if (EO.target.value == '') {
                _this.setState({ chCount: { errText: 'Поле не может быть пустым', err: 1 } });
            } else {
                var val = Number.parseInt(EO.target.value);
                if (!val) {
                    _this.setState({ chCount: { errText: 'Значение должно быть числом', err: 1 } });
                } else if (val < 0) {
                    _this.setState({ chCount: { errText: 'Значение должно быть больше нуля', err: 1 } });
                } else _this.setState({ chCount: { errText: '', err: 0, data: val } });
            }
        }, _this.saveItem = function () {
            var elArr = [_this.state.chImgURL, _this.state.chCount, _this.state.chTitle, _this.state.chDescription, _this.state.chPrice];
            var err = elArr.reduce(function (e, v) {
                e += v.err;return e;
            }, 0);
            if (err == 0) {
                var chItem = {
                    imgURL: _this.state.chImgURL.data,
                    title: _this.state.chTitle.data,
                    description: _this.state.chDescription.data,
                    price: _this.state.chPrice.data,
                    count: _this.state.chCount.data,
                    code: _this.props.item.code
                };
                _this.props.cbChangeItem({ item: chItem });
            } else {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.lockEdit ? null : _react2.default.createElement('input', { type: 'file', accept: 'image/*,image/jpeg', onChange: this.selectFile })
                    ),
                    _react2.default.createElement(
                        'span',
                        { className: 'ErrorText' },
                        ' ',
                        this.state.chImgURL.errText
                    )
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', {
                            type: 'text',
                            defaultValue: this.this.props.item.title,
                            disabled: this.props.lockEdit,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('textarea', {
                            rows: '10',
                            cols: '30',
                            defaultValue: this.this.props.item.description,
                            disabled: this.props.lockEdit,
                    ...
                    _react2.default.createElement(
                        ...
                        { className: 'ErrorText' },
                        ' ',
                        this.state.chDescription.errText
                    )
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', {
                            type: 'text',
                            defaultValue: this.this.props.item.price,
                            disabled: this.props.lockEdit,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', {
                            type: 'number',
                            defaultValue: this.this.props.item.count,
                            disabled: this.props.lockEdit,
                    ...
                    _react2.default.createElement(
                        ...
                        { className: 'ErrorText' },
                        ' ',
                        this.state.chCount.errText
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'Field Buttoms' },
                    _react2.default.createElement('input', {
                        value: '\u041E\u0442\u043C\u0435\u043D\u0430',
                        onClick: this.cancelForm
                        //{(this.props.lockEdit)?null:<input type='button' value='Сохранить' onClick={this.saveItem}/>}
                    })
                )
            );
        }
...
ItemForm.propTypes = {
    ...
    cbChangeItem: _propTypes2.default.func.isRequired,
    cbCloseForm: _propTypes2.default.func.isRequired
};
